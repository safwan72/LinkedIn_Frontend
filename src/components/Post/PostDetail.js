...
const PostDetail = ({ myid, token, postId, open, handleClickClose }) => {
  ...
  React.useEffect(() => {
    ...
    async function fetchData() {
      if (myid) {
        const request = await axios.get(
          `${baseURL}api/post/checkIfLiked/${myid}/${postId}/`,
          header
        );
    ...
    async function fetchData() {
      if (myid) {
        const request = await axios.post(
          `${baseURL}api/post/addComment/${myid}/${postId}/`,
          {
          ...
          <Container sx={{ mt: "20px" }}>
            ...
            >
              ...
              <Box sx={{ flex: 1 }}>
                ...
                >
                  <Typography variant="body1">{post?.post_title}</Typography>
                  <Box
                    sx={{
                      mt: "40px",
                      mb: "10px",
                        ...
                        <ThumbUpIcon
                          ...
                          onClick={() => {
                            ...
                            async function fetchData() {
                              if (myid) {
                                const request = await axios.get(
                                  `${baseURL}api/post/removeLike/${myid}/${post?.id}/`,
                                  header
                                );
                                setIfLiked(request?.data);
                                return request;
                        ...
                        <ThumbUpOffAltIcon
                          ...
                          onClick={() => {
                            ...
                            async function fetchData() {
                              if (myid) {
                                const request = await axios.get(
                                  `${baseURL}api/post/addLike/${myid}/${post?.id}/`,
                                  header
                                );
                                setIfLiked(request?.data);
                                return request;
                ...
                <Box sx={{ mb: "25px" }}>
                  {postComments &&
                    postComments?.map((item, i) => {
                      return <PostComment comment={item} key={i} />;
                    })}
                </Box>
              </Box>
            </Box>
